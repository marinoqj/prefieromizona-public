package es.golemdr.prefieromizona.ext.exceptions.resolver;
...
public class CustomExceptionResolver extends SimpleMappingExceptionResolver{
    ...
    public ModelAndView resolveException(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex) {
    	...
    	log.error(MessageFormat.format(Constantes.PREFIJO_MENSAJE_TIPO_EXCEPCION,ex.getMessage()));
    	log.error(MessageFormat.format(Constantes.PREFIJO_MENSAJE_CODIGO_EXCEPCION,codigo));    	
    	
    	String trazaLog = recuperarTraza(ex, "LOG");
    	log.error(MessageFormat.format(Constantes.PREFIJO_MENSAJE_TRAZA_EXCEPCION,trazaLog));   	
